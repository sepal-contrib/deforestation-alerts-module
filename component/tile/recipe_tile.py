...
class RecipeTile(sw.Layout):
    def __init__(
        ...
        self.create_new_btn = CustomBtnWithLoader(text="New Recipe", loader_type="text", large=True, class_="pa-1 ma-1")
        ...
        self.load_btn = CustomBtnWithLoader(text="Load Recipe", loader_type="text",  large=True, class_="pa-1 ma-1")
        ...
        self.load_recipe_input = sw.FileInput(
            class_="pa-1 ma-1 d-flex align-center",  large=True, extensions= ['.json'], folder = directory.module_dir
        )
    ...
    def create_recipe_function(self, widget, event, data):
        widget.set_loader_text('Creating recipe...')
        time.sleep(1)

        if self.analyzed_alerts_model.actual_alert_id != -1:
            widget.set_loader_text('Resetting models...')
            time.sleep(1)
            ...
            widget.set_loader_text('Resetting tiles...')
            time.sleep(1)
            ...
            link((self.aoi_tile.map_1, "center"), (self.alert_filter_tile.map_1, "center"))
    ...
    def load_recipe_button(self, widget, event, data):
        ...
        widget.set_loader_text('Loading AOI...')
        ...
        widget.set_loader_text('Loading Alerts...')
        #widget.set_loader_percentage(30)
        aoi_tile.process_alerts_silent()
        widget.set_loader_text('Loading Filters...')
        ...
        widget.set_loader_text('Waiting GEE...')
        ...
        widget.set_loader_text('Loading Alerts DB...')
        ...
        widget.set_loader_text('Loading last alert...')
