...
class AlertAnalysisModel(model.Model):
    ...
    last_save_time = Float(0).tag(sync=True)
    "Last time there was new save in alert database"
    ...
    def import_from_dictionary(self, data):
        ...
        try:
            ...
            self.last_save_time = data.get("last_save_time", datetime.today().timestamp())
